...
The template's existing `doc/40-ci-orchestration.md` can remain as a separate CI detail page; `doc/20-01-development.md` becomes the local developer/maintenance entrypoint and may link to it.
...
- every maintained rollout repository has `doc/20-01-development.md` with its local operating summary and exceptions;
