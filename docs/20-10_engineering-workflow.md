...
- [project organisation](40-02_projects.md) for generic project/tool ownership;
- [reusable repository documentation](20-13_repository-documentation.md) for the shared plan/development/specification/design/verification/usage document roles;
